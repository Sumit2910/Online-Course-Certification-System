...
// Fallback modules used if backend doesn't send module list
const FALLBACK_MODULES = {
  "101": [
    { id: 1, title: "Introduction & Course Overview", duration: "15 min", desc: "Welcome and course roadmap." },
    { id: 2, title: "Java Basics: Variables & Data Types", duration: "30 min", desc: "Primitive types, input/output, variables." },
...
async function loadCoursePage() {
  ...
  try {
    ...
    // Get modules (from API or fallback)
    ...
    try {
      const prog = await API.get("/api/progress/" + course.id);
